   ...
   (function()
    {
     ...
     function(err,stats)
     {
      ...
      else
      {
       ...
       {
        fs.watchFile(file_on_callback, function(curr, prev){
         if(curr.mtime.getTime() != prev.mtime.getTime()) restart_server(file_on_callback);
        } ); //probably may consume resources , but also tells whitch file
